package io.github.asmflow.assembly.armv7.execution.configurations
...
import io.github.asmflow.assembly.armv7.assembler.AssemblerResult
import io.github.asmflow.assembly.armv7.execution.AssemblyExecutionResult
import io.github.asmflow.assembly.armv7.execution.process.AssemblyEmulatorProcessHandler
...
class AssemblyRunProfileState(
    ...
    override fun execute(executor: Executor, runner: ProgramRunner<*>): ExecutionResult {
        ...
        val toolWindow = ToolWindowManager.getInstance(environment.project).getToolWindow(
            ARMv7RegisterViewToolWindowFactory.TOOL_WINDOW_ID
        ).toOption()
