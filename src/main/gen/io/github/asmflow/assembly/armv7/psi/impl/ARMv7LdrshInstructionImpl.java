...
public class ARMv7LdrshInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrshInstruction {

  public ARMv7LdrshInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrshInstruction(this);
  }
