...
public class ARMv7HexadecimalLiteralImpl extends ARMv7HexadecimalNumberMixinImpl implements ARMv7HexadecimalLiteral {

  public ARMv7HexadecimalLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitHexadecimalLiteral(this);
  }
