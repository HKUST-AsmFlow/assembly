...
public class ARMv7LdrexhInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrexhInstruction {

  public ARMv7LdrexhInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrexhInstruction(this);
  }
