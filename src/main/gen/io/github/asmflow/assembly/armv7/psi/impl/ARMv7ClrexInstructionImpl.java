...
public class ARMv7ClrexInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7ClrexInstruction {

  public ARMv7ClrexInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitClrexInstruction(this);
  }
