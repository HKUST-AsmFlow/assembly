...
public class ARMv7PCWithImmediateOffsetImpl extends ASTWrapperPsiElement implements ARMv7PCWithImmediateOffset {

  public ARMv7PCWithImmediateOffsetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitPCWithImmediateOffset(this);
  }
