...
public class ARMv7LdmibInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdmibInstruction {

    public ARMv7LdmibInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitLdmibInstruction(this);
    }
