...
public class ARMv7LdrexbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrexbInstruction {

  public ARMv7LdrexbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrexbInstruction(this);
  }
