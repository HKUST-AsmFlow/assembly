...
public class ARMv7BinaryLiteralImpl extends ARMv7BinaryNumberMixinImpl implements ARMv7BinaryLiteral {

  public ARMv7BinaryLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
