...
public class ARMv7LdrbtInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrbtInstruction {

  public ARMv7LdrbtInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrbtInstruction(this);
  }
  ...
  public ARMv7PostindexOffset getPostindexOffset() {
    return findNotNullChildByClass(ARMv7PostindexOffset.class);
  }
