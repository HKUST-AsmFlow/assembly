...
public class ARMv7CmnInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7CmnInstruction {

    public ARMv7CmnInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitCmnInstruction(this);
    }
