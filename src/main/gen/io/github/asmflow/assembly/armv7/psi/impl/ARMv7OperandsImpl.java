...
public class ARMv7OperandsImpl extends ASTWrapperPsiElement implements ARMv7Operands {

  public ARMv7OperandsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ARMv7Operand> getOperandList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ARMv7Operand.class);
  }
