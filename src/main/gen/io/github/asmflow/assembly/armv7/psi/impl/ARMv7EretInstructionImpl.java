...
public class ARMv7EretInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7EretInstruction {

  public ARMv7EretInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitEretInstruction(this);
  }
