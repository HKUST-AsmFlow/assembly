...
public class ARMv7LdrexInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrexInstruction {

  public ARMv7LdrexInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrexInstruction(this);
  }
