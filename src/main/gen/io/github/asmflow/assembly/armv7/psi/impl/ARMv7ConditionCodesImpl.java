...
public class ARMv7ConditionCodesImpl extends ASTWrapperPsiElement implements ARMv7ConditionCodes {

  public ARMv7ConditionCodesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitConditionCodes(this);
  }
