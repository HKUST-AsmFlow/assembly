...
public class ARMv7PostindexImmediateOffsetImpl extends ASTWrapperPsiElement implements ARMv7PostindexImmediateOffset {

  public ARMv7PostindexImmediateOffsetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitPostindexImmediateOffset(this);
  }
