...
public class ARMv7SetsConditionFlagsImpl extends ASTWrapperPsiElement implements ARMv7SetsConditionFlags {

  public ARMv7SetsConditionFlagsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitSetsConditionFlags(this);
  }
