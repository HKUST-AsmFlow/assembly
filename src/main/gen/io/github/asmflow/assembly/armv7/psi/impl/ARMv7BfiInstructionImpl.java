...
public class ARMv7BfiInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7BfiInstruction {

  public ARMv7BfiInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitBfiInstruction(this);
  }
