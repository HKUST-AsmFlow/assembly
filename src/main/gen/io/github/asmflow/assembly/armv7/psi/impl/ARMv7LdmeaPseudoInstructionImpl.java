...
public class ARMv7LdmeaPseudoInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdmeaPseudoInstruction {

    public ARMv7LdmeaPseudoInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitLdmeaPseudoInstruction(this);
    }
