...
public class ARMv7PreindexRegisterOffsetImpl extends ASTWrapperPsiElement implements ARMv7PreindexRegisterOffset {

  public ARMv7PreindexRegisterOffsetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitPreindexRegisterOffset(this);
  }
