...
public class ARMv7DsbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7DsbInstruction {

  public ARMv7DsbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitDsbInstruction(this);
  }
