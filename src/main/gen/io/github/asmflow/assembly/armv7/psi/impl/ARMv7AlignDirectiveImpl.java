...
public class ARMv7AlignDirectiveImpl extends ASTWrapperPsiElement implements ARMv7AlignDirective {

    public ARMv7AlignDirectiveImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    @Override
    @NotNull
    public List<ARMv7Based> getBasedList() {
        return PsiTreeUtil.getChildrenOfTypeAsList(this, ARMv7Based.class);
    }
