...
public class ARMv7LdrexdInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrexdInstruction {

  public ARMv7LdrexdInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrexdInstruction(this);
  }
