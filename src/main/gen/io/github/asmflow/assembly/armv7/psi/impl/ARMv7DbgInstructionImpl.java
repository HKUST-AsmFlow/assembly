...
public class ARMv7DbgInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7DbgInstruction {

    public ARMv7DbgInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitDbgInstruction(this);
    }
