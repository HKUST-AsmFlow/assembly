...
public class ARMv7AsciiDirectiveImpl extends ASTWrapperPsiElement implements ARMv7AsciiDirective {

  public ARMv7AsciiDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitAsciiDirective(this);
  }
