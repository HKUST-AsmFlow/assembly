...
public class ARMv7RegisterWithWritebackImpl extends ARMv7RegisterWithWritebackOperandMixinImpl implements ARMv7RegisterWithWriteback {

  public ARMv7RegisterWithWritebackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitRegisterWithWriteback(this);
  }
