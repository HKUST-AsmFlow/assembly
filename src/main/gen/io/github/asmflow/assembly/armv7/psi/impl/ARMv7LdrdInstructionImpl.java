...
public class ARMv7LdrdInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrdInstruction {

  public ARMv7LdrdInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrdInstruction(this);
  }
