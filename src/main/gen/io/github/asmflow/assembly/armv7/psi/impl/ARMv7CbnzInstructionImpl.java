...
public class ARMv7CbnzInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7CbnzInstruction {

  public ARMv7CbnzInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitCbnzInstruction(this);
  }
