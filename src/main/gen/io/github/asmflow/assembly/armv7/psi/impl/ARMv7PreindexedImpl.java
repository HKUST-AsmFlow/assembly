...
public class ARMv7PreindexedImpl extends ARMv7PreindexedOperandMixinImpl implements ARMv7Preindexed {

  public ARMv7PreindexedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitPreindexed(this);
  }
