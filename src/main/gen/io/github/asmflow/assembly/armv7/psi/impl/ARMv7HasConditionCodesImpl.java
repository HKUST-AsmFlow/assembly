...
public class ARMv7HasConditionCodesImpl extends ASTWrapperPsiElement implements ARMv7HasConditionCodes {

  public ARMv7HasConditionCodesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitHasConditionCodes(this);
  }
