...
public class ARMv7IsbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7IsbInstruction {

  public ARMv7IsbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitIsbInstruction(this);
  }
