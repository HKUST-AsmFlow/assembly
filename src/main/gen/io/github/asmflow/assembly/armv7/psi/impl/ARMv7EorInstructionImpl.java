...
public class ARMv7EorInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7EorInstruction {

    public ARMv7EorInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitEorInstruction(this);
    }
