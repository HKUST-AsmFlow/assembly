...
public class ARMv7BkptInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7BkptInstruction {

  public ARMv7BkptInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitBkptInstruction(this);
  }
