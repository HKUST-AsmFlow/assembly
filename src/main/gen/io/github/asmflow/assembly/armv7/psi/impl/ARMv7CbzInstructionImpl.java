...
public class ARMv7CbzInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7CbzInstruction {

  public ARMv7CbzInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitCbzInstruction(this);
  }
