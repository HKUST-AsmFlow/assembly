...
public class ARMv7LdrsbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrsbInstruction {

  public ARMv7LdrsbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrsbInstruction(this);
  }
