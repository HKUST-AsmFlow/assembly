...
public class ARMv7BxjInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7BxjInstruction {

    public ARMv7BxjInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitBxjInstruction(this);
    }
