...
public class ARMv7AdrInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7AdrInstruction {

  public ARMv7AdrInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitAdrInstruction(this);
  }
