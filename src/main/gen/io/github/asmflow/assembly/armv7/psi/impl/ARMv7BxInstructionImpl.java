...
public class ARMv7BxInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7BxInstruction {

    public ARMv7BxInstructionImpl(@NotNull ASTNode node) {
        super(node);
    }

    public void accept(@NotNull ARMv7Visitor visitor) {
        visitor.visitBxInstruction(this);
    }
