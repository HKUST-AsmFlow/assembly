...
public class ARMv7LdrshtInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrshtInstruction {

  public ARMv7LdrshtInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrshtInstruction(this);
  }
