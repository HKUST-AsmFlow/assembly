...
public class ARMv7LdrtInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdrtInstruction {

  public ARMv7LdrtInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdrtInstruction(this);
  }
