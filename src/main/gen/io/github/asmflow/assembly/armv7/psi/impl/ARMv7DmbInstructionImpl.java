...
public class ARMv7DmbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7DmbInstruction {

  public ARMv7DmbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitDmbInstruction(this);
  }
