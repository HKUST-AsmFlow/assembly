...
public class ARMv7DecimalLiteralImpl extends ARMv7DecimalNumberMixinImpl implements ARMv7DecimalLiteral {

  public ARMv7DecimalLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
