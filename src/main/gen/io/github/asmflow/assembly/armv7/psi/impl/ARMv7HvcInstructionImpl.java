...
public class ARMv7HvcInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7HvcInstruction {

  public ARMv7HvcInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitHvcInstruction(this);
  }
