...
public class ARMv7BicInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7BicInstruction {

  public ARMv7BicInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitBicInstruction(this);
  }
