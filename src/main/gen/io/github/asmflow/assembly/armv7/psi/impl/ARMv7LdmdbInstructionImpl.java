...
public class ARMv7LdmdbInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdmdbInstruction {

  public ARMv7LdmdbInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdmdbInstruction(this);
  }
