...
public class ARMv7LdmiaPseudoInstructionImpl extends ARMv7InstructionSuffixImpl implements ARMv7LdmiaPseudoInstruction {

  public ARMv7LdmiaPseudoInstructionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull ARMv7Visitor visitor) {
    visitor.visitLdmiaPseudoInstruction(this);
  }
